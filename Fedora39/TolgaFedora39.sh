...
install_gpu_drivers() {
	...
	sudo dnf install https://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-$(rpm -E %fedora).noarch.rpm
        ...
        install_package "xorg-x11-drv-nvidia-cuda-libs"
        install_package "gcc"
        install_package "kernel-headers"
        install_package "xorg-x11-drv-nvidia"
        install_package "xorg-x11-drv-nvidia-libs"
        install_package "vdpauinfo"
        install_package "libva-vdpau-driver"
        install_package "libva-utils"
        install_package "vulkan"
        install_package "akmods"
        install_package "nvidia-vaapi-driver"
        install_package "make"
        install_package "dkms"
        install_package "acpid"
        install_package "libglvnd-glx"
        install_package "libglvnd-opengl"
        install_package "libglvnd-devel"
        install_package "pkgconfig"
        install_package "nvidia-settings"
        install_package "nvidia-persistenced"
        install_package "xorg-x11-drv-nvidia-power"
        install_package "tar"
        ...
        install_package "nvidia-persistenced"
        install_package "xorg-x11-drv-nvidia-power"
        install_package "nvidia-driver:latest-dkms"
